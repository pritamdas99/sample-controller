...
type KlusterInterface interface {
	...
	Apply(ctx context.Context, kluster *pritamdasdevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error)
	ApplyStatus(ctx context.Context, kluster *pritamdasdevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error)
	KlusterExpansion
}
...
func newKlusters(c *PritamdasV1alpha1Client, namespace string) *klusters {
	return &klusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *klusters) Apply(ctx context.Context, kluster *pritamdasdevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error) {
	if kluster == nil {
...
func (c *klusters) ApplyStatus(ctx context.Context, kluster *pritamdasdevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error) {
	if kluster == nil {
		return nil, fmt.Errorf("kluster provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
