...
func (c *FakeKlusters) Apply(ctx context.Context, kluster *pritamdasdevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error) {
	if kluster == nil {
...
func (c *FakeKlusters) ApplyStatus(ctx context.Context, kluster *pritamdasdevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error) {
	if kluster == nil {
		return nil, fmt.Errorf("kluster provided to Apply must not be nil")
	}
	data, err := json.Marshal(kluster)
